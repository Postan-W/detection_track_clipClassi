    ...
    def task(self):
        while True:
            ...
            if not frame.stops:
                ...
                result = self.yolo_model.track(persist=True,verbose=False,source=frame.data,tracker=self.track_config,classes=[0,2],conf=0.7,iou=0.7,stream=False,show_labels=False,show_conf=False,show_boxes=False,save=False,save_crop=False)[0]#因为只有一张图片
...
if __name__ == '__main__':
    ...
    video_path = "C:/Users/wmingdru/Desktop/workspace/projects/detection_track_clipClassi/videos/output/allscenes_merged.mp4"
    output_path = "outputs/climb_20240627_1.mp4"
