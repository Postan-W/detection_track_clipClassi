    ...
    def task(self):
        while True:
            ...
            if not frame.stops:
                ...
                result = self.yolo_model.track(persist=True,verbose=False,source=frame.data,tracker=self.track_config,classes=[5],conf=0.35,iou=0.7,stream=False,show_labels=False,show_conf=False,show_boxes=False,save=False,save_crop=False)[0]#因为只有一张图片
...
if __name__ == '__main__':
    ...
    output_path = "outputs/fanyue_negative_6classes_clip.mp4"
