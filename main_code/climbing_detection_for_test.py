    ...
    def task(self):
        while True:
            ...
            if not frame.stops:
                ...
                result = self.yolo_model.track(persist=True,verbose=True,source=frame.data,tracker=self.track_config,classes=[1],conf=0.7,iou=0.7,stream=False,show_labels=False,show_conf=False,show_boxes=False,save=False,save_crop=False)[0]#因为只有一张图片
...
if __name__ == '__main__':
    ...
    video_path = "../videos/output/merged_video618_2.mp4"
    output_path = "outputs/output_yolov8l618.mp4"
